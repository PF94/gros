...
objects = loader.o gdt.o port.o interruptstubs.o interrupts.o keyboard.o mouse.o kernel.o bouncy_ball.o
...
# the tutorial was using vbox but it didn't work on my install
